...
const logger = require('kafka-node/lib/logging')('kafka-node:ConsumerGroup');
const util = require('util');
const EventEmitter = require('events');
const KafkaClient = require('kafka-node/lib/kafkaClient');
const Offset = require('kafka-node/lib/offset');
const _ = require('lodash');
const async = require('async');
const validateConfig = require('kafka-node/lib/utils').validateConfig;
const ConsumerGroupRecovery = require('kafka-node/lib/consumerGroupRecovery');
const Heartbeat = require('kafka-node/lib/consumerGroupHeartbeat');
const createTopicPartitionList = require('kafka-node/lib/utils').createTopicPartitionList;
const errors = require('kafka-node/lib/errors');
const NestedError = require('nested-error-stacks');

const assert = require('assert');
const builtInProtocols = require('kafka-node/lib/assignment');
