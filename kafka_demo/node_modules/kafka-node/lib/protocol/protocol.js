...
var protocol = require('kafka-node/lib/protocol/protocol_struct');
var getCodec = require('kafka-node/lib/codec');
...
const MessageSizeTooLarge = require('kafka-node/lib/errors/MessageSizeTooLargeError');
const SaslAuthenticationError = require('kafka-node/lib/errors/SaslAuthenticationError');
const InvalidRequestError = require('kafka-node/lib/errors/InvalidRequestError');
...
function decodeVersionsResponse (resp) {
  const MAX_SUPPORT_VERSION = require('kafka-node/lib/protocol/protocolVersions').maxSupport;
